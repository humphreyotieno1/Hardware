      ...
      <CardContent className="space-y-6">
        ...
        {serviceRequest && (
          <div>
            ...
            <div className="space-y-2">
              {/* Handle both ServiceRequest types: { type, details } and { services, description } */}
              {(serviceRequest as any).services ? (
                <>
                  {(serviceRequest as any).services.map((service: string) => (
                    <Badge key={service} variant="secondary" className="mr-2">
                      {service}
                    </Badge>
                  ))}
                  {(serviceRequest as any).description && (
                ...
                <>
                  ...
                  {serviceRequest.details && Object.keys(serviceRequest.details).length > 0 && (
                    <p className="text-sm text-muted-foreground mt-2">
                      {JSON.stringify(serviceRequest.details)}
                    </p>
                  )}
                </>
              )}
