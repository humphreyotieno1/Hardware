...
export function Footer() {
  ...
  const openWhatsApp = () => {
    ...
    const url = env.getWhatsAppUrl(`Hello! I'm interested in your hardware products.${companyInfo}`)
    window.open(url, '_blank')
  }

  const makeCall = () => {
    window.location.href = env.getTelLink()
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/categories/construction" className="text-muted-foreground hover:text-foreground transition-colors">
                    Construction
                  </Link>
                </li>
                <li>
                  <Link href="/categories/tools" className="text-muted-foreground hover:text-foreground transition-colors">
                    Tools
                  </Link>
                </li>
                <li>
                  <Link href="/categories/plumbing" className="text-muted-foreground hover:text-foreground transition-colors">
                    Plumbing
                  </Link>
                </li>
                <li>
                  <Link href="/categories/electrical" className="text-muted-foreground hover:text-foreground transition-colors">
                    Electrical
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-muted-foreground">{env.CONTACT_PHONE}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Mail className="h-4 w-4 text-muted-foreground" />
                  <span className="text-muted-foreground">{env.CONTACT_EMAIL}</span>
                </div>
              </div>
            </div>
          </div>
